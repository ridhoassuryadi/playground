...
var $author$project$Viewer$Cred$addHeaderIfAvailable = F2(
	function (maybeCred, builder) {
		if (maybeCred.$ === 'Just') {
			...
			return A2($author$project$Viewer$Cred$addHeader, cred, builder);
		} else {
			return builder;
		}
	});
...
var $author$project$Timestamp$fromString = function (str) {
	var _v0 = $rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(str);
	if (_v0.$ === 'Ok') {
		var successValue = _v0.a;
...
var $author$project$Article$allArticlesUrl = function (paths) {
	return $author$project$Api$url(
		A2($elm$core$List$cons, 'articles', paths));
};
var $author$project$Article$Slug$toString = function (_v0) {
	var str = _v0.a;
	return str;
};
var $author$project$Article$url = F2(
	function (articleSlug, paths) {
		return $author$project$Article$allArticlesUrl(
			A2(
				$elm$core$List$cons,
				$author$project$Article$Slug$toString(articleSlug),
				paths));
	});
...
var $author$project$Article$fetch = F2(
	function (maybeCred, articleSlug) {
		var expect = $elm$http$Http$expectJson(
			A2(
		...
		return $lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A2(
				$author$project$Viewer$Cred$addHeaderIfAvailable,
				maybeCred,
				A2(
					$lukewestby$elm_http_builder$HttpBuilder$withExpect,
					expect,
					$lukewestby$elm_http_builder$HttpBuilder$get(
						A2($author$project$Article$url, articleSlug, _List_Nil)))));
	});
...
var $author$project$Article$Comment$allCommentsUrl = F2(
	function (articleSlug, paths) {
		return $author$project$Api$url(
			_Utils_ap(
				_List_fromArray(
...
var $author$project$PaginatedList$fromList = F2(
	function (totalCount, list) {
		return $author$project$PaginatedList$PaginatedList(
			{page: 1, total: totalCount, values: list});
	});
...
var $author$project$PaginatedList$fromRequestBuilder = F3(
	function (resultsPerPage, pageNumber, builder) {
		...
		return A2(
			...
			$elm$http$Http$toTask(
				$lukewestby$elm_http_builder$HttpBuilder$toRequest(
					A2($lukewestby$elm_http_builder$HttpBuilder$withQueryParams, params, builder))));
	});
...
var $lukewestby$elm_http_builder$HttpBuilder$withQueryParam = F3(
	function (key, value, builder) {
		return A2(
...
var $author$project$Page$Home$fetchFeed = F3(
	function (session, feedTabs, page) {
		...
		var builder = function () {
			switch (feedTabs.$) {
				case 'YourFeed':
					var cred = feedTabs.a;
					return A2(
						$author$project$Viewer$Cred$addHeader,
						cred,
						$lukewestby$elm_http_builder$HttpBuilder$get(
				...
				default:
					var tag = feedTabs.a;
					return A3(
						$lukewestby$elm_http_builder$HttpBuilder$withQueryParam,
						'tag',
		...
		return A2(
			...
			A3(
				$author$project$PaginatedList$fromRequestBuilder,
				$author$project$Page$Home$articlesPerPage,
				page,
				A2(
					$lukewestby$elm_http_builder$HttpBuilder$withExpect,
					$elm$http$Http$expectJson(
						A2($author$project$Article$Feed$decoder, maybeCred, $author$project$Page$Home$articlesPerPage)),
					builder)));
	});
...
var $author$project$Article$Tag$list = A2(
	$elm$http$Http$get,
	$author$project$Api$url(
		_List_fromArray(
			['tags'])),
...
var $author$project$Page$Profile$fetchFeed = F4(
	function (session, feedTabs, username, page) {
		...
		var extraParamName = _v0.a;
		var extraParamVal = _v0.b;
		return A2(
			$elm$core$Task$attempt,
						...
						A2(
							...
							A3(
								...
								A2(
									$lukewestby$elm_http_builder$HttpBuilder$withExpect,
									$elm$http$Http$expectJson(
										A2($author$project$Article$Feed$decoder, maybeCred, $author$project$Page$Profile$articlesPerPage)),
									$lukewestby$elm_http_builder$HttpBuilder$get(
										$author$project$Api$url(
											_List_fromArray(
												['articles']))))))))));
...
var $author$project$Viewer$email = function (_v0) {
	var info = _v0.a;
	return info.email;
};
var $author$project$Viewer$profile = function (_v0) {
	var info = _v0.a;
	return info.profile;
};
var $author$project$Avatar$toMaybeString = function (_v0) {
	var maybeUrl = _v0.a;
	return maybeUrl;
};
	...
	return _Utils_Tuple2(
		{
			form: function () {
				...
				if (_v0.$ === 'Just') {
					var viewer = _v0.a;
					var profile = $author$project$Viewer$profile(viewer);
					var cred = $author$project$Viewer$cred(viewer);
					return {
						avatar: A2(
							$elm$core$Maybe$withDefault,
							'',
							$author$project$Avatar$toMaybeString(
...
var $author$project$Viewer$Internals = F3(
	function (cred, profile, email) {
		return {cred: cred, email: email, profile: profile};
	});
...
var $author$project$Viewer$Cred$decoder = A3(
	...
	A3(
		...
		'username',
		$author$project$Username$decoder,
		$elm$json$Json$Decode$succeed($author$project$Viewer$Cred$Cred)));
var $author$project$Viewer$decoder = A2(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'email',
		$author$project$Email$decoder,
		A2(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
			$author$project$Profile$decoder,
			A2(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
				$author$project$Viewer$Cred$decoder,
...
var $author$project$Session$decode = F2(
	function (key, value) {
		...
		if (_v0.$ === 'Just') {
			var decodedViewer = _v0.a;
			return A2($author$project$Session$LoggedIn, key, decodedViewer);
		} else {
	...
	function (flags, url, navKey) {
		return A2(
			...
			$author$project$Main$Redirect(
				A2($author$project$Session$decode, navKey, flags)));
	});
...
var $author$project$Article$Comment$commentUrl = F2(
	function (articleSlug, commentId) {
		return A2(
			$author$project$Article$Comment$allCommentsUrl,
			articleSlug,
			_List_fromArray(
				[
		...
		return $lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A2(
				...
				$lukewestby$elm_http_builder$HttpBuilder$delete(
					A2($author$project$Article$Comment$commentUrl, articleSlug, commentId))));
	});
	...
	function (slug, cred) {
		return $lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A2(
				...
				cred,
				$lukewestby$elm_http_builder$HttpBuilder$delete(
					A2($author$project$Article$url, slug, _List_Nil))));
	});
...
var $author$project$Article$buildFavorite = F3(
	function (builderFromUrl, articleSlug, cred) {
		var expect = $elm$http$Http$expectJson(
			A2(
				$elm$json$Json$Decode$field,
				'article',
...
var $author$project$Article$favorite = F2(
	function (articleSlug, cred) {
		return A3($author$project$Article$buildFavorite, $lukewestby$elm_http_builder$HttpBuilder$post, articleSlug, cred);
	});
					...
					$elm$http$Http$expectJson(
						A2(
							...
							$author$project$Article$Comment$decoder(
								$elm$core$Maybe$Just(cred)))),
					A2(
						$lukewestby$elm_http_builder$HttpBuilder$withBody,
...
var $author$project$Author$requestHelp = F3(
	function (builderFromUrl, uname, cred) {
		return $lukewestby$elm_http_builder$HttpBuilder$toRequest(
			A2(
				$lukewestby$elm_http_builder$HttpBuilder$withExpect,
				$elm$http$Http$expectJson(
					A2(
						$elm$json$Json$Decode$field,
						'profile',
						$author$project$Author$decoder($elm$core$Maybe$Nothing))),
				A2(
					$author$project$Viewer$Cred$addHeader,
					cred,
					builderFromUrl(
...
var $author$project$Author$requestFollow = F2(
	function (_v0, cred) {
		var uname = _v0.a;
		return A3($author$project$Author$requestHelp, $lukewestby$elm_http_builder$HttpBuilder$post, uname, cred);
	});
var $author$project$Author$requestUnfollow = F2(
	function (_v0, cred) {
		var uname = _v0.a;
		return A3($author$project$Author$requestHelp, $lukewestby$elm_http_builder$HttpBuilder$delete, uname, cred);
	});
var $author$project$Article$unfavorite = F2(
	function (articleSlug, cred) {
		return A3($author$project$Article$buildFavorite, $lukewestby$elm_http_builder$HttpBuilder$delete, articleSlug, cred);
	});
...
var $author$project$Email$encode = function (_v0) {
	var str = _v0.a;
		...
		_List_fromArray(
			[
				...
				$author$project$Avatar$encode(
					$author$project$Profile$avatar(info.profile))),
				_Utils_Tuple2(
				'token',
				$author$project$Viewer$Cred$encodeToken(info.cred)),
				_Utils_Tuple2(
				'bio',
				function () {
					var _v1 = $author$project$Profile$bio(info.profile);
					if (_v1.$ === 'Just') {
						var bio = _v1.a;
						return $elm$json$Json$Encode$string(bio);
					} else {
						return $elm$json$Json$Encode$null;
					}
				}())
	...
	return $author$project$Session$storeSession(
		$elm$core$Maybe$Just(
			A2(
				...
				0,
				$author$project$Viewer$encode(newViewer))));
};
		...
		switch (msg.$) {
			...
			case 'CompletedLogin':
				if (msg.a.$ === 'Err') {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Session$login(viewer));
				}
			default:
				var session = msg.a;
				return _Utils_Tuple2(
...
var $author$project$Page$Settings$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SubmittedForm':
				var cred = msg.a;
				var _v1 = $author$project$Page$Settings$validate(model.form);
				if (_v1.$ === 'Ok') {
					var validForm = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'CompletedSave':
				if (msg.a.$ === 'Err') {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Session$login(cred));
				}
			default:
				var session = msg.a;
				return _Utils_Tuple2(
	...
	function (maybeCred, timeZone, article) {
		...
		var faveButton = function () {
			if (maybeCred.$ === 'Just') {
				var cred = maybeCred.a;
				var _v2 = $author$project$Article$metadata(article);
				var favoritesCount = _v2.favoritesCount;
				var favorited = _v2.favorited;
	...
	function (toMsg, _v0) {
		...
		var viewPageLink = function (currentPage) {
			return A3(
				...
				toMsg,
				currentPage,
				_Utils_eq(currentPage, info.page));
		};
		return (info.total > 1) ? A2(
			$elm$html$Html$ul,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				viewPageLink,
				A2($elm$core$List$range, 1, info.total))) : $elm$html$Html$text('');
	});
var $author$project$Article$Feed$viewPagination = F2(
	function (toMsg, _v0) {
		var feed = _v0.a;
		return A2($author$project$PaginatedList$view, toMsg, feed.articles);
	});
														...
														$elm$core$List$concat(
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																	[
																		A2($author$project$Article$Feed$viewPagination, $author$project$Page$Home$ClickedFeedPage, feed)
																	])
																])))
													]);
											case 'Loading':
			...
			switch (_v0.$) {
				case 'Loaded':
					...
					var followButton = function () {
						var _v2 = $author$project$Session$cred(model.session);
						if (_v2.$ === 'Just') {
							var cred = _v2.a;
							switch (author.$) {
								case 'IsViewer':
																	...
																	$elm$core$List$concat(
																		_List_fromArray(
																			[
																				...
																				_List_fromArray(
																				[
																					A2($author$project$Article$Feed$viewPagination, $author$project$Page$Profile$ClickedFeedPage, feed)
																				])
																			])))
																]))
														]))
...
var $author$project$Page$Settings$SubmittedForm = function (a) {
	return {$: 'SubmittedForm', a: a};
};
	...
	function (cred, form) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onSubmit(
					$author$project$Page$Settings$SubmittedForm(cred))
				]),
			_List_fromArray(
				[
					A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													A2($author$project$Page$Settings$viewForm, cred, model.form)
												]))
										]))
								]))
						]));
