...
uses UASAL, uInsertMasterPegawai, uMasterDokter, uMasterKegunaanObat,
  uMasterKeluarga, uMasterLogin, uMasterObat, uMasterPasien,
  uMasterPilihan, uMenuAwal, uPasien, upilihdokter, uSplash;
...
procedure Tformrecorddokter.Image9Click(Sender: TObject);
begin
formmaindokter.Show;
formrecorddokter.Hide;
end;

procedure Tformrecorddokter.Image10Click(Sender: TObject);
begin
formrecorddokter.Hide;
formpengobatan.Show;
end;
